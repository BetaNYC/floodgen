...
const StreetInfo = () => {
  return (
    <div className='absolute bottom-0 lg:left-[2rem] lg:top-[1.75rem] px-[1rem] pt-[1.56rem] lg:pt-4 w-full lg:w-[17.56rem] h-[9.375rem] lg:h-[7.75rem] bg-white rounded-[1rem] z-20'>
